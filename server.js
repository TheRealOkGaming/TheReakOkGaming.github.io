...
(async () => {
    try {
        ...
        // Set up session middleware after successful Redis connection
        app.use(session({
            ...
            cookie: { secure: process.env.NODE_ENV === 'production' } // Set based on environment
        }));
